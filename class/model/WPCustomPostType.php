...
//region update functions::
    ...
    {
//        model\Log::Insert(1, $this->getID(), $this->getTitle(), $title);
...
//        model\Log::Insert(3, $this->getID(), $this->getDate()->getDateStringJalali(), $publishDate->getDateStringJalali());
    ...
    {
        // region model\Log Old Files Holder::
