...
// region Class Public Functions::
    ...
    /**
     * @return  string model\Attachment URL, otherwise ''.
     */
...
// region Class Static Functions::
    ...
    {
        return parent::Get('attachment', 'model\Attachment', $metaQuery, $count, $from, $to, $orderBy, $order);
    }
