...
// region Class Update Functions::
    ...
    public function updateStaff($value): bool
    {
       return $this->updatePostMeta('Client_Employees', $value);
    }
...
//region temporary func
    public static function GetOrphanUsers(): array
    {
        ...
        $orphans = $user_query->get_results();
        $list = array();
        foreach ($orphans as $orphan) {
            $list[] =new User($orphan->ID);
        }
        return $list;
